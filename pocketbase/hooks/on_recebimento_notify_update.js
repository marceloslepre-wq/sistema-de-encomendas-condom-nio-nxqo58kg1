onRecordAfterUpdateSuccess((e) => {
  try {
    ...
    if (status === originalStatus) return e.next()
    ...
    if (!shouldSend || !targetInstance) {
      console.log(
        'WhatsApp envio update pulado: condomínio desconectado e não é o condomínio de teste',
      )
      return e.next()
    }
    ...
    console.log('Error in notify update', err)
  }
  return e.next()
